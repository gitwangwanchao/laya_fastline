...
DOMParser.prototype.parseFromString = function(t, e) {
    ...
    r.errorHandler = buildErrorHandler(i, o, a),
    r.domBuilder = n.domBuilder || o,
    /\/x?html?$/.test(e) && (l.nbsp = " ", l.copy = "©", c[""] = "http://www.w3.org/1999/xhtml"),
    c.xml = c.xml || "http://www.w3.org/XML/1998/namespace",
    t ? r.parse(t, c, l) : r.errorHandler.error("invalid doc source"),
    o.doc
},
DOMHandler.prototype = {
    ...
    startElement: function(t, e, n, r) {
        ...
        for (var c = 0; a > c; c++) {
            ...
            l = r.getValue(c),
            n = r.getQName(c),
            s = o.createAttributeNS(t, n);
            this.locator && position(r.getLocator(c), s),
            s.value = s.nodeValue = l,
    ...
    characters: function(t) {
        if (t = _toString.apply(this, arguments)) {
            if (this.cdata) var e = this.doc.createCDATASection(t);
            else var e = this.doc.createTextNode(t);
    ...
    setDocumentLocator: function(t) { (this.locator = t) && (t.lineNumber = 0)
    },
    comment: function(t) {
        t = _toString.apply(this, arguments);
        var e = this.doc.createComment(t);
        this.locator && position(this.locator, e),
        appendElement(this, e)
    },
    startCDATA: function() {
        this.cdata = !0
    },
    ...
    fatalError: function(t) {
        throw console.error("[xmldom fatalError]	" + t, _locator(this.locator)),
        t
    }
},
...
DOMImplementation = exports.DOMImplementation = require("./dom").DOMImplementation;
