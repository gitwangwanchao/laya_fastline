...
namespace game.view
{
    export class FZBossNode extends FZBaseNode 
    {
        ...
        {
            FZEventManager.instance.register(FZEvent.GAME_VIEW_GAME_JUDGE_BULLET_POS,this.judgeHit, this);
        }
        public unregisterEvent():void
        {
            FZDebug.D("FZBossNode -----------------------------  destroy");
            FZEventManager.instance.unregister(FZEvent.GAME_VIEW_GAME_JUDGE_BULLET_POS,this.judgeHit, this);
        }
        public init() {
            this.scene = new ui.view.BossEnemyCarUI();
            this.scene.visible = false;
            this.scene.zOrder = 10;
            this.scene.img_air_shadow_1.filters = [FZGameData.instance.blackFilter];
            this.scene.img_air_shadow_2.filters = [FZGameData.instance.blackFilter];
            this.state = 0;
            this.box_posit = {};
            this.box_left_posit ={};
        ...
        public setEnemyData(value:any):void 
        {
            ...
            this.fireSpeed = 1000;
            // 刷新 敌人图片
            var data = FZGameData.instance.getCheckPointData();
            // 血量
            if (value.cartype == 4) {
            ...
            var skill_info = FZCfgManager.instance.getBossSkill();
            var checkpoint_info = FZGameData.instance.getCheckPointData();
            FZDebug.D("skill_info =================== " + JSON.stringify(skill_info));
            FZDebug.D("this.kill_index =================== " + value.skills);
            FZDebug.D("checkpoint_info.skillLv =========== " + checkpoint_info.skillLv);
            ...
            this.speed = FZGameData.instance.getMapSpeed() - this.speed_running;
        ...
        public judgeHit(params) {
            if (this.state == 1 ) {
                if (FZGameData.instance.JudgeRectangular(params, this.box_posit) == true) {
                    this.onHit({type:2, attack: params.attack});
                } 
                if (this.air_left_hp > 0 && FZGameData.instance.JudgeRectangular(params, this.box_left_posit) == true) {
                    this.onHitAirCarft({type:1, attack: params.attack});
                }
                if (this.air_right_hp > 0 && FZGameData.instance.JudgeRectangular(params, this.box_right_posit) == true) {
        ...
        public startMove(position:any):void
        {
            ...
            // FZDebug.log(" x :"+position.x+" y : "+position.y);
        ...
        public startFire() {
            if (this.state == 1 && this.statestop == false && FZGameData.instance.game_stop == false) { 
                var pos = FZGameData.instance.getFZPlayerUIPos();
                ...
                this.bullet_rota = FZUtils.getAngle(this.local_pos.x , this.local_pos.y , pos.x, pos.y);
                ...
                Laya.Tween.to(this.scene.img_weapons_icon, {rotation: this.bullet_rota}, 50, null ,Laya.Handler.create(this, function(){
                    ...
                    FZGameData.instance.getBulletPool(1).startFire(position);
                }));
            }
        }
        ...
        public UpdatePos():void
        {
            ...
            this.speed_w = this.speed * FZGameData.instance.getGameTime();
            if(this.cartype == 3 || this.cartype == 4) {
                // 精英 
                this.UpdateElitePos();
                return;
        ...
        public onJudgeOutScreen(){
            ...
            if (this.scene.y > FZGameData.instance.getFZPlayerUIPos().y + 300) {
                this.state = 0;
                FZGameData.instance.killBossEnemyPoolList(this);
            }
        }
        ...
        public UpdateElitePos():void {
            ...
            if (this.state == 1 ) {
                ...
                if(!this.isStop)
                {
                    ...
                    Laya.Tween.to(this.scene,{x:this.bossPos[this.bossPosIndex[this.curBossMovePos-1]-1][0],y:this.bossPos[this.bossPosIndex[this.curBossMovePos-1]-1][1]},1500,null,Laya.Handler.create(this,()=>{
                        let sequence = FZSequence.create(); 
            ...
            if (this.state == 4) {
                this.scene.y  += 10 * FZGameData.instance.getGameTime(); 
                if (this.scene.y >= 300) {
                    this.state = 1;
                }
            }   
        ...
        public playAni(falg:Boolean = true,isDelayTime:boolean = false) {
            ...
            this.onUpdateBoxPosit();
            this.scene.img_air.visible = false;
            if (FZGameData.instance.judgeBossCheckPoint == false) {
                // 没有boss
                if (FZGameData.instance.LevelEnemyCount == 0 ) {
                    // this.state = 5;
                    if (falg == true){
                        FZEventManager.instance.sendEvent(FZEvent.GAME_VIEW_GAME_PLAY_GAME_OVER);
                    }
                    this.scene.animation_fire.interval = 120;
                }else {
                    this.scene.animation_fire.interval = 30;
                }
            } else if(FZGameData.instance.judgeBossCheckPoint == true) {
                // 有boss
                if(FZGameData.instance.LevelEnemyCount == 0){
                    if (this.cartype == 4) {
                        if (falg == true){
            ...
            Laya.timer.once(delayTime,this,()=>{
                ...
                Laya.timer.frameOnce(1, this, function(){
                    ...
                    FZSoundManager.instance.playSfx(FZSoundManager.instance.soundInfo_wav.explosionflame);
        ...
        public JudgeProps() :void
        {
            ...
            if (this.cartype == 3){
                position["Boss"] = 1;
                FZEventManager.instance.sendEvent(FZEvent.GAME_VIEW_CREATE_PROBS, position);
            } else if ( this.cartype == 4 ){
                position["Boss"] = 2;
                FZEventManager.instance.sendEvent(FZEvent.GAME_VIEW_CREATE_PROBS, position);
            }
        ...
        private onPlaySkillAnimation() {    
            if (FZGameData.instance.game_stop == true || this.statestop == true){
                return;
            }
            ...
            Laya.timer.once(1000, this, function(){
                if(this.statestop != true){
                    ...
                    FZGameData.instance.playSkill(param);
                }
            });
...
export default game.view.FZBossNode;