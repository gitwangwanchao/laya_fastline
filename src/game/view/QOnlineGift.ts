...
namespace game.view
{
    export class QOnlineGift extends QBaseUI
    {
                ...
                for(let i = 0;i<3;i++)
                {
                    ...
                    if(awardcfg['award_type'] !=3)
                    {
                        ...
                        if(awardcfg['award_type'] == 1)
                        {
                            ...
                            let diamondNum = Number(QMergeData.instance.getCarBuyPriceDiamond(this.carCfg[(this.CarMaxLevel-2) + '']['id']));
                        ...
                        else
                        {
                            ...
                            let money = (QGameData.instance.getCheckPointData()).dropCash; 
        ...
        {
            QEventMgr.instance.sendEvent(QEventType.GET_GIFT_SUCCESS);  //在线宝箱获取成功
            this.onBackHall(0);
            QUIMgr.instance.removeUI(QUIMgr.UI_OnlineGift);
        }
        ...
        public isSameday(){
            ...
            if(day.toString() != QSavedDateItem.instance.getItemFromLocalStorage("DAY_ONLINE_GIFT", "0")){
                //不是同一天
         ...
         */
        dateStorage(day){
            QSavedDateItem.instance.setItemToLocalStorage("DAY_ONLINE_GIFT", day);
        }
    }
}
export default game.view.QOnlineGift;