...
namespace game.view{
    ...
    export class FZGameGuide extends FZBaseUI{
        ...
        {
            FZEventManager.instance.register(FZEvent.GAME_GUIDE_CTRL,this.nextStep, this);
        }
        public unregisterEvent():void
        {
            FZEventManager.instance.unregister(FZEvent.GAME_GUIDE_CTRL,this.nextStep, this);
        }
        ...
        public stepNumber(perform: Array<any>): any{
            ...
            FZUIManager.instance.removeUI(FZUIManager.UI_GameGuideView);
            return -1;
        }
        ...
        public perfromGuide(){
            let step = this.step;
            if(this.stepIdx!=FZGameStatus.NumForGuide.enterGame&&this.stepIdx!=FZGameStatus.NumForGuide.enterGameAgain&&this.stepIdx!=FZGameStatus.NumForGuide.weaponUpdate){
                this.scene.cacheAs = "bitmap";
                ...
                if (this.stepIdx == FZGameStatus.NumForGuide.buyCar) {
                    this.scene.click_img.blendMode = "";
                }else {
                    this.scene.click_img.blendMode = "lighter";
                }
            }else if(this.stepIdx==FZGameStatus.NumForGuide.weaponUpdate){
            ...
            switch (key[this.ui_step]) {
                case 1:
                    if(this.stepIdx==2){
                        ...
                        if(this.stepIdx==FZGameStatus.NumForGuide.weaponUpdate){
        ...
        public calculateRectSize(nodeArr: Array<any>, key: number = 0): any {
            if(nodeArr.length && nodeArr[this.ui_step]){
                ...
                FZEventManager.instance.sendEvent(FZEvent.FORCE_GUIDE_START,[nodeArr]);//开始强制引导
                let info = {
                    handPos:{
                        x: 0,
                        y: 0,
                ...
                switch(key[this.ui_step]){
                    case 1:
                        ...
                        if(this.stepIdx==FZGameStatus.NumForGuide.weaponUpdate){  //武器升级
                            ...
                            // console.log("1");
                            // FZEventManager.instance.sendEvent(FZEvent.WEAPON_GUIDE, this.scene.guide_tip.zOrder);
        ...
        public nextStep(){
            ...
            {
                FZGameData.instance.newPlayerGudieStep(this.stepIdx);
        ...
        public checkGuideProcess(){
            switch(this.stepIdx)
            {
                case FZGameStatus.NumForGuide.synthetic:
                    let CarSlotData = FZMergeDateManager.instance.getCarSlotData();
...
export default game.view.FZGameGuide;