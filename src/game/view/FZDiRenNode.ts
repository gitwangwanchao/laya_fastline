...
namespace game.view
{
    export class FZDiRenNode extends FZBaseNode 
    {
        ...
        public startFire() {
            if (this.state == 1 && this.statestop == false && FZGameData.instance.game_stop == false) {
                ...
                //FZEventManager.instance.sendEvent(FZEvent.BOSS_START_SHOOT);
        ...
        public onGameOver() {
            if (this.scene.visible == true) {
                FZGameData.instance.killEnemyPoolList(this);
            }
        }
        ...
        public UpdatePos():void
        {
            ...
            if (this.state == 1 || this.state == 2){
                this.scene.y += this.speed_w;
                if (this.state == 1 && this.scene.y >=  FZGameData.instance.getFZPlayerUIPos().y+150) {
                    this.state = 3;
                }
            }   
            if (this.state == 4) {
                ...
                if (this.scene.y > this.Max) {
                    ...
                    this.speed = Math.max(FZGameData.instance.getMapSpeed() - this.speed_running, this.speed); 
                }
            }
            this.onUpdateBoxPosit();
        }
        ...
        public playAni(falg:Boolean = true,isDelayTime:boolean = false) {
            ...
            Laya.timer.once(delayTime,this,()=>{
                ...
                Laya.timer.frameOnce(1, this, function(){
                    FZGameData.instance.playExplosion({type:3,x:this.scene.x , y:this.scene.y });
                    if (falg == true) {
                        // 判断道具
                        this.JudgeProps();
                    }
        ...
        public onHit(param:any):any {
            ...
            if (this.HP <= 0){
                ...
                if(this.getCartype() == 5)
                {
                    FZGameData.instance.explodeCarDie(this);
                }
        ...
        public judgeHit(params) {
            if (this.state == 1 && FZGameData.instance.JudgeRectangular(params, this.box_posit) == true) {
...
export default game.view.FZDiRenNode;