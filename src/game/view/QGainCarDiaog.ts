...
namespace game.view
{
    export class QGainCarDialog extends QBaseUI
    {
        public scene: ui.view.QGainCarDiaogUI;
        private carInfo:any;
        ...
        public unregisterEvent() : void   
        {
            ...
            QSceneMgr.instance.uiScene.active = false;
        ...
        public init():void
        {
            ...
            if(QSceneMgr.instance.uiScene != null) {
                Laya.stage.addChild(QSceneMgr.instance.uiScene);
                QSceneMgr.instance.uiScene.zOrder = 10;
                QSceneMgr.instance.uiScene.updateZOrder();
            }
            this.scene = new ui.view.QGainCarDiaogUI();
            this.scene.zOrder = 10;
            this.scene.updateZOrder();
            let curMaxLevel = this.carMaxLv = QMergeData.instance.getCarMaxLevel();
            this.carInfo = QCfgMgr.instance.getCarInfoById(curMaxLevel);
            this.baseMainWeaponData = QCfgMgr.instance.getBaseMainWeapons();
            this.mianWeaponLevel = QGameData.instance.getMainWeaponLevel();

            let carBattleData = QCfgMgr.instance.getCarInfoById(curMaxLevel);
            let mainWeaponData = QCfgMgr.instance.getMainWeapons(carBattleData.mainWeaponId);

            // QUtil.doUIPopAnim(this.scene.AnchorCenter);
            var old_path = QCfgMgr.instance.getCarInfoById(curMaxLevel-1).path;
            ...
            let uavWeaponOpen = QGameData.instance.getUAVWeaponOpenPoint();
            let deputyWeaponOpen = QGameData.instance.getDeputyWeaponOpenPoint();
            ...
            Laya.timer.frameOnce(60, this, function(){
                ...
                QSceneMgr.instance.uiScene.active = true;
            ...
            QUIMgr.instance.RegisterBtnClickWithAnim(this.scene.btnVideo, this, this.onClickBtnVideo, ["btnVideo"]);
            QUIMgr.instance.RegisterBtnClickWithAnim(this.scene.btn_close, this, this.onClickClose,[]);
        ...
        private onClickBtnConfirm():void
        {
            ...
            param.shareType = QGameConst.QShareType.showof;
        ...
        public openShareCallBack() {
            if (QMergeData.instance.showWeaponOpenNotice && (this.showOpenDeputy || this.showOpenUav)) {
                // 显示副武器或无人机跳转提示
                let param = this.showOpenDeputy ? "deputy" : "uav"
                QUIMgr.instance.createUI(QUIMgr.UI_WeaponLockedNoticeView, param);
            } else {
            ...
            QUIMgr.instance.removeUI(QUIMgr.UI_GainCar);
        }
        ...
        public shareCallBack(){
            if (this.carInfo.share_diamond != 0) {
                QMergeData.instance.addGameDiamond(this.carInfo.share_diamond);
                QUIMgr.instance.createUI(QUIMgr.UI_Tip,{text: "获得钻石"+ this.carInfo.share_diamond});
                QGameData.instance.playResFlyAni(this.scene.img_diamond,this.scene.title_diamond,{type: 2,countType: 0},this.hide.bind(this));
                if(this.carMaxLv == 2)
                {
...
export default game.view.QGainCarDialog;