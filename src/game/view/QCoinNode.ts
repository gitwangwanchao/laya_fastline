...
namespace game.view
{
    export class QCoinNode extends QBaseNode 
    {
        ...
        public onGameOver() {
            if (this.probs_state != 0 && this.scene.visible == true) {
                QEventMgr.instance.sendEvent(QEventType.GAME_VIEW_GAME_WEAPONS_COIN);
                QGameData.instance.killCoinPoolList(this);
            }
        }
        /**
         *  结束子弹
        ...
        public startMove(value:any, id :number, end:any):void 
        {
            ...
            this.end_p = (this.scene.parent as Laya.Sprite).globalToLocal(new Laya.Point(end.x, end.y)); //QUtil.globalToLocal(this.end_p,this.scene);;
            this.m_type += id;
            this.m_id = id;
        ...
        private UpdatePos() {
            ...
            this.m_t += this.counts; //* QGameData.instance.getGameTime();
            ...
            if (this.m_t == 1) {
                ...
                Laya.timer.frameOnce(1, this, function() {
                    if(this.item_data.item_type == 5 ) {
                        ...
                        QGameData.instance.checkpoint_diamond += this.item_data.amount1;
                    }else if(this.item_data.item_type == 6 ) {
                        // 美钞
                        QSoundMgr.instance.playSfx(QSoundMgr.instance.soundInfo_wav.getMoney);
                        QGameData.instance.checkpoint_dollars += this.item_data.amount1;
                    }
                    QEventMgr.instance.sendEvent(QEventType.GAME_VIEW_GAME_WEAPONS_COIN);
                    QGameData.instance.killCoinPoolList(this);
                });
...
export default game.view.QCoinNode;