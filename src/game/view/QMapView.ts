...
{
    export class QMapView extends Laya.Script{
        ...
        {
            QEventMgr.instance.register(QEventType.GAME_VIEW_GAME_START, this.onGameStart, this);
            ...
            QEventMgr.instance.register(QEventType.GAME_VIEW_GAME_ENEMY_OVER, this.onGameEnemyOver, this);
            ...
            QEventMgr.instance.register(QEventType.GAME_VIEW_GAME_PLAY_SPRINT, this.onPlaySprint, this);
            QEventMgr.instance.register(QEventType.GAME_VIEW_GAME_PLAY_SPRINT_CANNEL, this.onPlaySprintCannel, this);   
            QEventMgr.instance.register(QEventType.GAME_VIEW_GAME_RESURRECT_MAP, this.onGameResurrect, this);  
            QEventMgr.instance.register(QEventType.GAME_VIEW_GAME_OVER, this.OnKill, this);   
            
            
        }
        public unregisterEvent():void
        {
            QEventMgr.instance.unregister(QEventType.GAME_VIEW_GAME_START, this.onGameStart, this);
            ...
            QEventMgr.instance.unregister(QEventType.GAME_VIEW_GAME_ENEMY_OVER, this.onGameEnemyOver, this);
            QEventMgr.instance.unregister(QEventType.GAME_VIEW_GAME_WIN, this.onGameWin, this);
            QEventMgr.instance.unregister(QEventType.GAME_VIEW_GAME_PLAY_SPRINT, this.onPlaySprint, this);
            QEventMgr.instance.unregister(QEventType.GAME_VIEW_GAME_PLAY_SPRINT_CANNEL, this.onPlaySprintCannel, this);
            QEventMgr.instance.unregister(QEventType.GAME_VIEW_GAME_FAIL, this.onGameFail, this);  
            QEventMgr.instance.unregister(QEventType.GAME_VIEW_GAME_RESURRECT_MAP, this.onGameResurrect, this);   
            QEventMgr.instance.unregister(QEventType.GAME_VIEW_GAME_OVER, this.OnKill, this);
        }
        public OnKill() : void
        {
        ...
        public init():void
        {
            this.map_speed = QGameData.instance.map_speed;
            this.perRoadLength = (this.uiComponent.getChildByName("img_bg_1") as Laya.Image).height;
            this.map_index = QGameData.instance.getCheckPointData().map;
        ...
        public onPlaySprint():void 
        {
            if (this.owner){
                ...
                this.map_speed = QGameData.instance.getMapSpeed();
            }
        ...
        public onUpdate():void{
            ...
            // QEventMgr.instance.sendEvent(QEventType.MAIN_VIEW_UPDATE);
            QGameData.instance.UpdatePos();
            this.speed_dis = this.map_speed * QGameData.instance.getGameTime();
        ...
        public creatEnemy() {
            if (this.gameEnemyOver == false && this.game_running == true && Math.floor(this.run_distance/this.run_distance_m) != this.run_number) {
                ...
                Laya.timer.frameOnce(1,this, function(){
                    QGameData.instance.onCreateWaveEnemy();
                });
            }
        }
...
export default fastline.view.QMapView;