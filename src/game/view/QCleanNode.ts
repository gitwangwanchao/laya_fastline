...
export default class QCleanNode extends Laya.Image{
    ...
    {
        // 选中车辆
        QEventMgr.instance.register(QEventType.MAIN_VIEW_TOUCH_SELECTED, this.onCleanState, this);
        // 监听 抬起 
        QEventMgr.instance.register(QEventType.MAIN_VIEW_TOUCH_UP, this.onMouseUp, this);
        // 车辆销毁
        QEventMgr.instance.register(QEventType.CAR_SELL_PRICE, this.onTips, this);
        // 垃圾桶变化
        QEventMgr.instance.register(QEventType.IN_CLEAN, this.changeCleanNode, this);
        QEventMgr.instance.register(QEventType.OUT_CLEAN, this.changeCleanNode, this);
    }
    public unregisterEvent():void
    {
        QEventMgr.instance.unregister(QEventType.MAIN_VIEW_TOUCH_UP, this.onMouseUp, this);
        QEventMgr.instance.unregister(QEventType.MAIN_VIEW_TOUCH_SELECTED, this.onCleanState, this);
        QEventMgr.instance.unregister(QEventType.CAR_SELL_PRICE, this.onTips, this);
        QEventMgr.instance.unregister(QEventType.IN_CLEAN, this.changeCleanNode, this);
        QEventMgr.instance.register(QEventType.OUT_CLEAN, this.changeCleanNode, this);
    }
    public destroy() : void
    {
    ...
    public onTips(carPrice: any):void 
    {
        ...
        addGold.text = "+$" + QUtil.formatNumberStr(gold + "");
    ...
    public changeCleanNode(flag){
        ...
        if(flag){
            ...
            if(QGameData.instance.delCarGuideState == "InGuide" || QGameData.instance.deleteCarGuide != "Close"){
                QEventMgr.instance.sendEvent(QEventType.DELETE_CAR_TRASH_STATE , "IN");
            }
        }else{
            clean.alpha = 0.7;
            clean.scaleX = 1;
            clean.scaleY = 1;
            if(QGameData.instance.delCarGuideState == "InGuide" || QGameData.instance.deleteCarGuide != "Close"){
                QEventMgr.instance.sendEvent(QEventType.DELETE_CAR_TRASH_STATE , "OUT");
            }
        } 
    }
    ...
    {
        if(QMergeData.instance.getCarMaxLevel() <= 7 && QMergeData.instance.getIsFirstRecycleCarState() == 0)
        {
        ...
        if (this.onJudge(param) == true){
            ...
            // 出售
            QEventMgr.instance.sendEvent(QEventType.MAIN_VIEW_CAR_SELL);
            ...
            if(QGameData.instance.delCarGuideState == "InGuide" || QGameData.instance.deleteCarGuide != "Close"){
                QEventMgr.instance.sendEvent(QEventType.DELETE_CAR_TRASH_STATE , "SELL");
            }
            // QGameData.instance.playResFlyAni(this,null,{type: 1,countType: 0},null);//播放飘金币的动画
            tywx.BiLog.clickStat(tywx.clickStatEventType.successSellCar,[]);
            
            QMergeData.instance.setIsFirstRecycleCarState(1);
        }
    }
