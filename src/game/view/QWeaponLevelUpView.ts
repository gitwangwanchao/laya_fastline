...
namespace game.view
{
    export class QWeaponLevelUpView extends QBaseUI
    {
        ...
        // --------------------------------------
        // 该变量使用于: 子弹变化
        public bulletShootTimes = QGameData.instance.bulletShootTimes;  //子弹发射次数
        // 副武器 - 子弹
        ...
        public registerEvent():void{
            ...
            QEventMgr.instance.register(QEventType.ON_UPDATE_WEAPONLEVEL_UI,this.onUpdateUI, this);
            QEventMgr.instance.register(QEventType.MAIN_VIEW_UPDATE_GAME_CASH,this.onUpdateGameCash, this);
            QEventMgr.instance.register(QEventType.MAIN_VIEW_UPDATE_DIAMOND,this.onUpdareDiamond, this);
            QEventMgr.instance.register(QEventType.GAME_LVUPFLYRES_CTRL,this.playFlyAni,this);
        }

        public unregisterEvent():void{
            QMergeData.instance.removeDBullet();
            Laya.timer.clear(this, this.onUpdatePos);
            QEventMgr.instance.unregister(QEventType.ON_UPDATE_WEAPONLEVEL_UI,this.onUpdateUI, this);
            QEventMgr.instance.unregister(QEventType.MAIN_VIEW_UPDATE_GAME_CASH,this.onUpdateGameCash, this);
            QEventMgr.instance.unregister(QEventType.MAIN_VIEW_UPDATE_DIAMOND,this.onUpdareDiamond, this);
            QEventMgr.instance.unregister(QEventType.GAME_LVUPFLYRES_CTRL,this.playFlyAni,this);
        ...
        public onDestroy() : void{
            if(this.inUpdateGudie){
                ...
                QEventMgr.instance.sendEvent(QEventType.FRESHAIRDROPSTATE);
            }
            QSoundMgr.instance.openWeaponLevelUp = 0;
        ...
        onUpdateGameCash():void{
            var str =  QUtil.formatNumberStr(QGameData.instance.getWeaponsCoin().toString()); 
        ...
        public init():void
        {
            ...
            QUtil.doUIPopAnim(this.scene.Anchorview);
            QSoundMgr.instance.openWeaponLevelUp = 1;
            ...
            this.curCarUseLevel = QMergeData.instance.getCarUsedLevel() || 1;
            this.curCarMaxLevel = QMergeData.instance.getCarMaxLevel() || 1;
            this.curCheckPoint = QGameData.instance.getCheckPoint() || 1;
        ...
        public checkGuide() 
        {
            if(QGameData.instance.newPlayerGudieStep(null) == QGameConst.NumForGuide.weaponUpdate){
                ...
                QUIMgr.instance.RegisterBtnClickWithAnim(this.scene.btn_guide_main_levelup, this, this.onClickMainLevelUp,[]);
            }
        }
        /**
         * 检查关闭按钮引导
        ...
        public checkCloseGuide(){
            if(QGameData.instance.newPlayerGudieStep(null) == QGameConst.NumForGuide.weaponUpdateBtn){
            //     //显示主武器引导
                this.scene.guide_box.visible = true;
                this.scene.guide_mask.width = Laya.stage.width;
                this.scene.guide_mask.height = Laya.stage.height;
                ...
                this.inUpdateGudie = true;
                QUIMgr.instance.RegisterBtnClickWithAnim(this.scene.btn_guide_close, this, this.onClickBtnClose,[]);
                // this.checkUpdateGuide();
            }
        }
        /**
         ...
         */
        checkLocking(){
            let deputyWeaponOpenPoint = QGameData.instance.getDeputyWeaponOpenPoint() || 1;
        ...
        setParam (param) {
            ...
            let coin = QGameData.instance.getWeaponsCoin() || 1;
            ...
            if (this.curCarMaxLevel >= QGameData.instance.getDeputyWeaponOpenPoint()) {
                this.initDeputy();
                this.showDeputyInfo();
            ...
            if (this.curCheckPoint >= QGameData.instance.getUAVWeaponOpenPoint()) {
                this.initUav();
                this.showUavInfo();
        ...
        private initDeputy():void{
            ...
            this.checkNotice();
            QGameData.instance.setDeputyWeaponOpenOpened();
            QUIMgr.instance.RegisterBtnClickWithAnim(this.scene.btn_deputy_levelup, this, this.onClickDeputyLevelUp, ["btn_deputy_levelup"]);
            
            QUIMgr.instance.RegisterBtnClickWithAnim(this.scene.deputy_preview_btn, this, this.onClickDeputyPreviewBtn,[]);

            QUIMgr.instance.RegisterBtnClickWithAnim(this.scene.btn_deputy_preview, this, this.onClickBtnDeputyPreview,[]);
            
            this.deputyWeaponMaxLevel = QGameData.instance.getDeputyWeaponMaxLevel();
            this.deputyWeaponLevel = QGameData.instance.getDeputyWeaponLocalLevel();
        ...
        private initMain():void{
            ...
            // Laya.timer.loop(130, this, this.playFireSound);
            this.checkNotice();
            QUIMgr.instance.RegisterBtnClickWithAnim(this.scene.btn_main_levelup, this, this.onClickMainLevelUp, ["btn_main_levelup"]);
            this.scene.main_preview_btn.visible = false;
            // QUIMgr.instance.RegisterBtnClickWithAnim(this.scene.Mainlist_container, this, this.onClickMainPreviewBtn,[]);  //预览按钮

            this.mainWeaponLevel = QGameData.instance.getMainWeaponLevel();
            this.baseMainWeaponData = QCfgMgr.instance.getBaseMainWeapons();
        }

        private initUav():void{
            this.checkNotice();
            QGameData.instance.setUavWeaponOpenOpened();

            QUIMgr.instance.RegisterBtnClickWithAnim(this.scene.btn_uav_levelup, this, this.onClickUavLevelUp, ["btn_uav_levelup"]);
            QUIMgr.instance.RegisterBtnClickWithAnim(this.scene.btn_uav_choose, this, this.onClickUavChoose, ["btn_uav_choose"]);
            ...
            this.UAVConfig = QCfgMgr.instance.getUAVWeaponsCfg();
            if(!this.UAVConfig){
                return;
            }
            ...
            this.UAVLocalData = QGameData.instance.getUAVData();
            this.uavWeaponMaxLevel = QGameData.instance.uavWeaponMaxLevel;
            this.curUseUAV = QGameData.instance.getCurUseUAV();
            QDebug.D("this.curUseUAV --------------------------------------   " + this.curUseUAV);
        ...
        private showDeputyWeaponBox () : void {
            ...
            let deputyWeaponOpenPoint = QGameData.instance.getDeputyWeaponOpenPoint();
            if (this.curCarMaxLevel < deputyWeaponOpenPoint) {
                Laya.timer.clear(this, this.deputyPlayFire);
                // Laya.timer.clear(this, this.onUpdatePos);
                Laya.timer.clear(this, this.mainPlayFire);
                //QUIMgr.instance.createUI(QUIMgr.UI_Tip,{text : "玩家解锁"+deputyWeaponOpenPoint+"级车辆开启"});
                QUIMgr.instance.createUI(QUIMgr.UI_WeaponUnlockNoticeView, {value: "deputy"});
                return;
            }
            ...
            //预览按钮skin初始化  
            if(this.tryFree || QGameData.instance.deputy_full_level_try != 0){
        ...
        private showUavWeaponBox () : void {
            ...
            Laya.timer.clear(this, this.mainPlayFire);
            // Laya.timer.clear(this, this.playFireSound);
            let uavWeaponOpenPoint = QGameData.instance.getUAVWeaponOpenPoint();
            if (this.curCheckPoint < uavWeaponOpenPoint) {
                
                //QUIMgr.instance.createUI(QUIMgr.UI_Tip,{text : "玩家解锁"+uavWeaponOpenPoint+"级车辆开启"});
                QUIMgr.instance.createUI(QUIMgr.UI_WeaponUnlockNoticeView, {value: "uav"});
                return;
            }
        ...
        */
        ...
        private showContainer(container: number):void{
            ...
            QDebug.D("showContainer ----------------------" + container);
        ...
        private showDeputyInfo():void{
            let curDeputyWeaponData = QCfgMgr.instance.getDeputyWeapons(this.deputyWeaponLevel);
            let curBulletData = QCfgMgr.instance.getBulletList(curDeputyWeaponData.sBullet);
            ...
            if (deputyFullLevel) {
                ...
                this.scene.lbl_deputy_lvup_pay.text = QUtil.formatNumberStr(this.deputyLevelUpPayCount+"");

                let nextDeputyWeaponData = QCfgMgr.instance.getDeputyWeapons(this.deputyWeaponLevel+1);
        ...
        checkDeputyNotice(){
            if (this.curCarMaxLevel >= QGameData.instance.getDeputyWeaponOpenPoint()) {
                ...
                if (deputyFullLevel) {
                    ...
                    let coin = this.isChoiceDeputyMoney ? QGameData.instance.getWeaponsCoin() : QMergeData.instance.getGameDiamond();
        ...
        private showMainInfo():void{
            ...
            let mainFullLevel = (this.mainWeaponLevel >= QGameData.instance.mainWeaponMaxLevel);
            ...
            if (mainFullLevel) {
                ...
                this.scene.lbl_main_lvup_pay.text = QUtil.formatNumberStr(this.mainLevelUpPayCount.toString()); 
            }
        }
        ...
        private showUavInfo():void{
            ...
            //     QEventMgr.instance.sendEvent(QEventType.UVA_CAN_CHOOSE, true);
            // }else{
            //     QEventMgr.instance.sendEvent(QEventType.UVA_CAN_CHOOSE, false);
            // }
            ...
            if (uavFullLevel) {
                ...
                this.scene.lbl_uav_lvup_pay.text = QUtil.formatNumberStr(this.uavLevelUpPayCount+"");
        ...
        checkAllUavFullLevel(): boolean{
            ...
            for(let i = 1; i < this.uavIndex + 1; i++){
                if(this.UAVLocalData[i + ""] < QGameData.instance.uavWeaponMaxLevel){
                    fullLevel = false;
                }
            }
            return fullLevel;
        ...
        checkAllWeaponsFullLevel(){
            ...
            // console.log("全部满级");
            QSavedDateItem.instance.setItemToLocalStorage("ALL_FULL_LEVEL", "true");
            return true;
        }
        ...
        private onClickDeputyLevelUp():void{
            if (this.deputyWeaponLevel >= this.deputyWeaponMaxLevel) {
                QUIMgr.instance.createUI(QUIMgr.UI_Tip,{text : "已达到最大等级"});
                QSoundMgr.instance.playSfx(QSoundMgr.instance.soundInfo_wav.touch);
                return;
            } 

            let posMoneyCount = this.isChoiceDeputyMoney ? QGameData.instance.getWeaponsCoin():QMergeData.instance.getGameDiamond();
            ...
            if (posMoneyCount >= this.deputyLevelUpPayCount) {
                ...
                QGameData.instance.setDeputyWeaponLocalLevel(this.deputyWeaponLevel);

                if(this.isChoiceDeputyMoney) QGameData.instance.addWeaponsCoin(this.deputyLevelUpPayCount*-1);
                else QMergeData.instance.addGameDiamond(this.deputyLevelUpPayCount*-1);
                
                this.showDeputyInfo();
                this.checkNotice();
                QSoundMgr.instance.playSfx(QSoundMgr.instance.soundInfo_wav.lvUp_deputyWeapon);
                ...
                QUIMgr.instance.createUI(QUIMgr.UI_Tip,{text : "资源不足"});
                QSoundMgr.instance.playSfx(QSoundMgr.instance.soundInfo_wav.touch);
                QUIMgr.instance.createUI(QUIMgr.UI_FreeGoldGet,QGameConst.QCurrencyType.dollar);
            }
        }
        /**
         * 主武器升级
        ...
        private onClickMainLevelUp():void{
            if(this.inUpdateGudie){
                ...
                QGameData.instance.newPlayerGudieStep(QGameConst.NumForGuide.weaponUpdateBtn);
            ...
            if (QGameData.instance.getWeaponsCoin() >= this.mainLevelUpPayCount) {
                QGameData.instance.addWeaponsCoin(this.mainLevelUpPayCount*-1);
                ...
                QGameData.instance.setMainWeaponLevel(this.mainWeaponLevel);
                this.showMainInfo();
                this.checkNotice();
                QSoundMgr.instance.playSfx(QSoundMgr.instance.soundInfo_wav.lvUp_uav);
        ...
        private onClickUavLevelUp():void{
            ...
            if (QGameData.instance.getWeaponsCoin() >= this.uavLevelUpPayCount) {
                QGameData.instance.addWeaponsCoin(this.uavLevelUpPayCount*-1);
                
                this.UAVLocalData[(this.curSelectUAVIndex+1) + ""]++;
                QGameData.instance.setUAVData(this.UAVLocalData);
                this.showUavInfo();
                this.checkNotice();
                QSoundMgr.instance.playSfx(QSoundMgr.instance.soundInfo_wav.lvUp_uav);
        ...
        private onClickUavChoose():void{
            QGameData.instance.setCurUseUAV(this.curSelectUAVIndex+1);
        ...
        private playFlyAni(param: any){
            QGameData.instance.playResFlyAni(null,this.scene.title_money,{type: param.itemType,countType: param.countType},null);
        }
            ...
            if(this.deputyPreviewBtnCtr == "open"){
                ...
                if (this.deputy_preview_state == 1) {  //不可以满级试用
                    ...
                    if(this.curViceMaxLevel >= 4){
                        ...
                        this.scene.label_already.visible = false;
                        if(QGameData.instance.deputy_full_level_try == 0){  //满级试用之前
                            this.scene.label_already_try.visible = false;
                        }else{  //处于满级试用期间
        ...
        public changeDeputyLeveUpBtn(): void{
            ...
            if(this.curViceMaxLevel > this.curSelectViceIndex){  //滑至低等级
                ...
                if(this.curViceMaxLevel + 1 < this.curSelectViceIndex){  //更高等级
                    ...
                    if(QGameData.instance.deputy_full_level_try != 0){  //满级试用label的显示控制
                        this.scene.label_already_try.visible = true;
                    }else{
                        this.scene.label_already_try.visible = false;
                    }
        ...
        public onClickBtnDeputyPreview(){
            if(this.tryFree){
                ...
                QUIMgr.instance.createUI(QUIMgr.UI_Tip, {text : "每天只能试用一次"});
            }
        }
        ...
        public successFreeTry(){
            if(QUtil.isNullOrEmpty(this.scene)) {
                return;
            }
            this.tryFree = false;
            QSavedDateItem.instance.setItemToLocalStorage("FREE_DEPUTY_VIDEO", "false");
            this.scene.label_free_try.visible = false;
            ...
            if(this.curViceMaxLevel <= 3 && this.curViceMaxLevel >= 0){
                QGameData.instance.deputy_full_level_try = (this.curViceMaxLevel + 1 + 1) * 20;
                QSavedDateItem.instance.setItemToLocalStorage("DEPUTY_FULL_LEVEL_TRY", QGameData.instance.deputy_full_level_try.toString());  //存储副武器试用等级
            }
            Laya.timer.once(1000, this, function(){
                QUIMgr.instance.createUI(QUIMgr.UI_Tip, {text : "快去游戏中试用一局吧！"});
            }); 
        }
        ...
        public isSameday(){
            ...
            if(day.toString() != QSavedDateItem.instance.getItemFromLocalStorage("DAY_FREE_DEPUTY", "0")){
                //不是同一天
                this.dateStorage(day);
                //每天可以试用一次
                this.tryFree = true;
                //刷新视频成功观看记录
                QSavedDateItem.instance.setItemToLocalStorage("FREE_DEPUTY_VIDEO", "true");
                //新的一天发送副武器试用结束事件
                QEventMgr.instance.sendEvent(QEventType.DEPUTY_PROBATION_OVER);
            }else{  //是同一天
                //判断是否成功观看过视频
                if(QSavedDateItem.instance.getItemFromLocalStorage("FREE_DEPUTY_VIDEO", "true") == "false"){  //成功观看过视频
                    this.tryFree = false;
                }else{  //没有成功观看过视频
                    this.tryFree = true;
                }
         ...
         */
        dateStorage(day){
            QSavedDateItem.instance.setItemToLocalStorage("DAY_FREE_DEPUTY", day);
        }
        ...
        public initViceWeaponData(){    
            ...
            getViceNumArr = QCfgMgr.instance.getViceWeaponLevelArr();
           ...
           for( var i = 0 ; i <  getViceNumArr.length ; i++ ){
               ...
               var mesConfig = QCfgMgr.instance.getDeputyWeapons(num);
               if( !  mesConfig ){
                   return;
               }
        ...
        public initMainWeaponData(){    
            ...
            var listArr = [];
            var dataArr = [];
            var getMainNumArr = QCfgMgr.instance.getMainWeaponLevelArea();
            if( getMainNumArr == -1 || getMainNumArr.length <= 0 ){ // 未获取配置,使用默认值
                getMainNumArr = 5;
            }
            this.mainSectionNum = getMainNumArr;  // 区间档位差距数值 

            var mainWeaponsData = QCfgMgr.instance.getBaseMainWeapons();
        ...
        initShowCar(){
            ...
            // 显示武器
            if(this.curCarMaxLevel < QGameData.instance.getDeputyWeaponOpenPoint()){  //未解锁副武器
        ...
        changeDeputyInCar(param){
            if( param == "deputy" || param == "both" ){
                // 刷新 副武器的图
                if (this.deputyWeaponLevel > 0){
                    var deputy_data = QCfgMgr.instance.getDeputyWeapons(this.deputyWeaponLevel);
            ...
            if( param == "main" || param == "both" ){
                ...
                // this.mianWeaponLevelForView = QGameData.instance.getMainWeaponLevel();
        ...
        changeWeaponShow(param,num){
            ...
            if ( param == "deputy" ){ 
                 ...
                 var deputy_data = QCfgMgr.instance.getDeputyWeapons(curDepuNum);
                 this.scene.img_deputy_weapons_icon_1_0.skin = deputy_data.sPic;
                 this.scene.img_deputy_weapons_icon_1_1.skin = deputy_data.sPic;
            } 
            // 刷新 主武器的图
         ...
         */
        public initDBullet(){
            QMergeData.instance.initBullet(this.scene.car_weapon);
            var that = this;
        }
        ...
        public getDeputyBulletData(){
            ...
            if(this.isDeputyPreview == true) {
                QDebug.D("获取不同等级下副武器子弹的数据 ----------------------------  " + this.curSelectViceIndex);
                curDeputyWeaponData = QCfgMgr.instance.getDeputyWeapons((this.curSelectViceIndex + 1) * 20);
                curBulletData = QCfgMgr.instance.getBulletList(curDeputyWeaponData.sBullet);
                if(!curDeputyWeaponData || !curBulletData){
                    return;
                }
            }
        ...
        public getMainBulletData(){
            ...
            var weapon_data_cur = QCfgMgr.instance.getMainWeapons(data.mainWeaponId);

            let curBulletData = QCfgMgr.instance.getBulletList(weapon_data_cur.bullet);
            if(!curBulletData){
                return;
            }
            ...
            //     curBulletData = QCfgMgr.instance.getBulletList(this.baseMainWeaponData[((this.curSelectMainIndex + 1) * 5).toString()].bullet);
            //     if(!curBulletData){
            //         return;
            //     }
        ...
        public deputyPlayFire(){
            ...
            for (var j = 0; j< 2; j++) {
                ...
                for (var i = 0; i < count; i++) {
                    var pos_data = QGameData.instance.getDeputyButtonInitialPos(main_ballistic,i,count);
                    ...
                    QMergeData.instance.getDBullet().startFire(bulletPoint1);
                }
            }
        }
         ...
         */
        public onUpdatePos() {
            if(QMergeData.instance.DBulletPoolJSList.length == 0){
                if (this.isPlayDeputyBullet == true){
                    if (this.current_view == 0){
                        QDebug.D("刷新子弹位置 ---------------- 播放副武器子弹");
                        this.onPlayDeputyFire();
                    }else if (this.current_view == 1){
                        this.onPlayMainFire();
                    }
                ...
                for (var i = QMergeData.instance.DBulletPoolJSList.length-1; i >= 0; i--){
                    QMergeData.instance.DBulletPoolJSList[i].UpdatePos();
                }
            }
        }
        /**
        ...
        public mainPlayFire() {
            ...
            for (var i = 0; i < count; i++) {
                ...
                rotation:deputy_rota, bulletModel: bulletModel , shadow_pic: shadow_pic,change_data:pos_data};
                QMergeData.instance.getDBullet().startFire(bulletPoint);
            }
        }
    } 
}

export default game.view.QWeaponLevelUpView;