...
import QCarSlotNode from "./QCarSlotNode";
...
import QGameGuide from "./QGameGuide";
...
namespace game.view
{
    export class QMainView extends QBaseUI
    {
        ...
        public registerEvent(): void
        {
            ...
            // 监听 选中状态
            QEventMgr.instance.register(QEventType.MAIN_VIEW_TOUCH_SELECTED, this.onSelectedCar, this);
            // 刷新车位
            QEventMgr.instance.register(QEventType.MAIN_VIEW_UPDATE_CAR_SLOT, this.onUpdateCarSlot, this);
            // 刷新经验
            QEventMgr.instance.register(QEventType.MAIN_VIEW_UPDATE_EXPERIENCE, this.onUpdateExperience, this);
            // 更新金币速率
            QEventMgr.instance.register(QEventType.MAIN_VIEW_UPDATE_GOLD_SPEED, this.onUpdateGoldSpeed, this);
            // 升级
            QEventMgr.instance.register(QEventType.MAIN_VIEW_UPDATE_LEVEL, this.onUpLevel, this);
            // 合成新车
            QEventMgr.instance.register(QEventType.MAIN_VIEW_MERGE_NEW_CAR, this.onCreateGainCarDiaog, this);
            // 刷新钻石
            QEventMgr.instance.register(QEventType.MAIN_VIEW_UPDATE_DIAMOND, this.onUpdareDiamond, this);
            // 刷新价格
            QEventMgr.instance.register(QEventType.MAIN_VIEW_CHANGE_PRICE, this.onChangePrice, this);
            // 刷新最优车
            QEventMgr.instance.register(QEventType.MAIN_VIEW_UPDATE_BUY_CAR, this.onUpdateBuyCar, this);
            // 更改当前使用赛车
            // QEventMgr.instance.register(QEventType.GAME_CHANGE_CUR_USE_CAR, this.changeCurUseCar, this);
            // 增加空投车数量
            QEventMgr.instance.register(QEventType.GAME_ADD_ITEM_CAR_COUNT, this.addItemCarCount, this);
            // 刷新关卡显示
            QEventMgr.instance.register(QEventType.GAME_UPDATE_POINT_SHOW, this.showPointInfo, this);

            QEventMgr.instance.register(QEventType.UPDATE_SHARE_CONFIG, this.updateShareConfig, this);

            QEventMgr.instance.register(QEventType.GAME_FLYRES_CTRL,this.flyResAni, this);

            QEventMgr.instance.register(QEventType.WX_ON_SHOW, this.onShow, this);
            QEventMgr.instance.register(QEventType.WX_ON_HIDE, this.onHide, this);

            QEventMgr.instance.register(QEventType.SOFT_GUIDE_INTERVENTION, this.resetSoftGuide, this);

            QEventMgr.instance.register(QEventType.MAIN_REFRESH_LUCKY_RED_POINT, this.refreshLuckyRedHint, this);
            //  在线宝箱获取成功 监听
            QEventMgr.instance.register(QEventType.GET_GIFT_SUCCESS, this.getGiftSuccess, this);
            //  删除车辆新手引导 监听
            QEventMgr.instance.register(QEventType.DELETE_CAR_TRASH_GUIDE, this.deleteCarGuideStart, this);
            //  删除车辆新手引导 状态变化
            QEventMgr.instance.register(QEventType.DELETE_CAR_TRASH_STATE, this.freshTrashState, this);
            //  继续游戏进入引导
            QEventMgr.instance.register(QEventType.CONTIMUE_GUIDE_ENTER,this.checkGuideStep, this);

            // QEventMgr.instance.register(QEventType.WEAPON_GUIDE, this.weapomGuide, this);
            //  开始强制引导配合监听
            QEventMgr.instance.register(QEventType.FORCE_GUIDE_START,this.startForceGuide, this);
            //  强制引导结束监听
            QEventMgr.instance.register(QEventType.GAME_GUIDE_CTRL,this.releaseForceGuide, this);
            // 开启空投动作
            QEventMgr.instance.register(QEventType.MAIN_OPEN_AIRDROP,this.openAirDrop, this);
            ...
            QEventMgr.instance.register(QEventType.FRESHAIRDROPSTATE, this.freshAirDropState, this);

            //试玩次数刷新监听
            QEventMgr.instance.register(QEventType.MORE_GAME_NUM, this.updateMoreGameNotice, this);

        }
        // 移除监听
        public unregisterEvent(): void
        {
            QEventMgr.instance.unregister(QEventType.FRESHAIRDROPSTATE, this.freshAirDropState, this);
            ...
            QEventMgr.instance.unregister(QEventType.MAIN_VIEW_TOUCH_SELECTED, this.onSelectedCar, this);
            QEventMgr.instance.unregister(QEventType.MAIN_VIEW_UPDATE_CAR_SLOT, this.onUpdateCarSlot, this);
            QEventMgr.instance.unregister(QEventType.MAIN_VIEW_UPDATE_EXPERIENCE, this.onUpdateExperience, this);
            QEventMgr.instance.unregister(QEventType.MAIN_VIEW_UPDATE_GOLD_SPEED, this.onUpdateGoldSpeed, this);
            QEventMgr.instance.unregister(QEventType.MAIN_VIEW_UPDATE_LEVEL, this.onUpLevel, this);
            QEventMgr.instance.unregister(QEventType.MAIN_VIEW_MERGE_NEW_CAR, this.onCreateGainCarDiaog, this);
            QEventMgr.instance.unregister(QEventType.MAIN_VIEW_UPDATE_DIAMOND, this.onUpdareDiamond, this);
            QEventMgr.instance.unregister(QEventType.MAIN_VIEW_CHANGE_PRICE, this.onChangePrice, this);
            QEventMgr.instance.unregister(QEventType.MAIN_VIEW_UPDATE_BUY_CAR, this.onUpdateBuyCar, this);
            // QEventMgr.instance.unregister(QEventType.GAME_CHANGE_CUR_USE_CAR, this.changeCurUseCar, this);
            QEventMgr.instance.unregister(QEventType.GAME_ADD_ITEM_CAR_COUNT, this.addItemCarCount, this);
            QEventMgr.instance.unregister(QEventType.GAME_UPDATE_POINT_SHOW, this.showPointInfo, this);
            QEventMgr.instance.unregister(QEventType.UPDATE_SHARE_CONFIG, this.updateShareConfig, this);
            QEventMgr.instance.unregister(QEventType.MAIN_REFRESH_LUCKY_RED_POINT, this.refreshLuckyRedHint, this);

            QEventMgr.instance.unregister(QEventType.GAME_FLYRES_CTRL,this.flyResAni, this);
            QEventMgr.instance.unregister(QEventType.SOFT_GUIDE_INTERVENTION, this.resetSoftGuide, this);
            QEventMgr.instance.unregister(QEventType.DELETE_CAR_TRASH_GUIDE, this.deleteCarGuideStart, this);
            QEventMgr.instance.unregister(QEventType.DELETE_CAR_TRASH_STATE, this.freshTrashState, this);

            QEventMgr.instance.unregister(QEventType.CONTIMUE_GUIDE_ENTER,this.checkGuideStep, this);
            QEventMgr.instance.unregister(QEventType.MAIN_OPEN_AIRDROP,this.openAirDrop, this);

            // QEventMgr.instance.unregister(QEventType.WEAPON_GUIDE, this.weapomGuide, this);


            QEventMgr.instance.unregister(QEventType.FORCE_GUIDE_START,this.startForceGuide, this);
            QEventMgr.instance.unregister(QEventType.GAME_GUIDE_CTRL,this.releaseForceGuide, this);
            ...
            QEventMgr.instance.unregister(QEventType.WX_ON_HIDE, this.onHide, this);
            // QEventMgr.instance.unregister(QEventType.UVA_CAN_CHOOSE,this.leveUpNoticeCtr, this);
            QEventMgr.instance.unregister(QEventType.MORE_GAME_NUM, this.updateMoreGameNotice, this);
        ...
        public init(): void
        {
            ...
            QUIMgr.instance.RegisterBtnClickWithAnim(this.scene.btn_shop, this, this.onBtnClick, ["btn_shop"]);
            // QUIMgr.instance.RegisterBtnClickWithAnim(this.scene.btn_time, this, this.onBtnClick, ["btn_time"]);
            QUIMgr.instance.RegisterBtnClickWithAnim(this.scene.btn_car_list, this, this.onBtnClick, ["btn_car_list"]);
            QUIMgr.instance.RegisterBtnClickWithAnim(this.scene.btn_start_game, this, this.onBtnClick, ["btn_start_game"]);
            QUIMgr.instance.RegisterBtnClickWithAnim(this.scene.sprte_change_car, this, this.onBtnClick, ["sprte_change_car"]);
            QUIMgr.instance.RegisterBtnClickWithAnim(this.scene.btn_add_diamond, this, this.onBtnClick, ["btn_add_diamond"]);
            QUIMgr.instance.RegisterBtnClickWithAnim(this.scene.btn_rotaryTable, this, this.onBtnClick, ["btn_rotaryTable"]);
            QUIMgr.instance.RegisterBtnClickWithAnim(this.scene.btn_levelUp, this, this.onBtnClick, ["btn_levelUp"]);
            QUIMgr.instance.RegisterBtnClickWithAnim(this.scene.dropBox, this, this.onBtnClick, ["air_drop_box"]);
            QUIMgr.instance.RegisterBtnClickWithAnim(this.scene.btn_more_game, this, this.onBtnClick, ["btn_more_game"]);
            QUIMgr.instance.RegisterBtnClickWithAnim(this.scene.btn_online_gift, this, this.onBtnClick, ["btn_online_gift"]);

            QUIMgr.instance.RegisterBtnClickWithAnim(this.scene.img_clean, this, this.onBtnClick, ["img_clean"]);
            ...
            if (local_date_str == "0") {
                ...
                QSavedDateItem.instance.setItemToLocalStorage("GAME_ROTARY_TABEL_CURR_COUNT", "5");
            }
            if (date_str != local_date_str) {
                QSavedDateItem.instance.setItemToLocalStorage("GAME_ROTARY_TABEL_DATE", date_str);
                var count = parseInt(QSavedDateItem.instance.getItemFromLocalStorage("GAME_ROTARY_TABEL_CURR_COUNT", "5"));
                var shareinfo:any = QCfgMgr.instance.getShareCfg();
                if (shareinfo.luckTableParam) {
                    count += shareinfo.luckTableParam.baseCount;
                    QSavedDateItem.instance.setItemToLocalStorage("GAME_ROTARY_TABEL_CURR_COUNT", count + "");
                }
            }
            ...
            //商城免费车检查
            if (QMergeData.instance.hasShopFreeCar) {
            ...
            Laya.timer.loop(5000, this, () => {
                QMergeData.instance.saveAllLocalData();
            });
            ...
            if (QMergeData.instance.showItemBox) {
                this.freshAirDropState();
            }
            // 随机免费车
            if (QMergeData.instance.showRandomCar) {
                Laya.timer.once(QMergeData.instance.BOX_TIME, this, this.onRandomCar);
            }
            ...
            if (QUIMgr.instance.longScreen()) {
                Laya.timer.frameOnce(1, this, () => {
                    ...
                    QGameData.instance.initTitlePos(this.scene.title_diamond,this.scene.title_gold);
                });
            }
            this.scene.img_levelUp_notice.visible = false;

            this.refreshLuckyRedHint();
            if (QGameData.instance.OpenUav == true){
                QUIMgr.instance.createUI(QUIMgr.UI_WeaponLockedNoticeView, "uav");
                QGameData.instance.OpenUav = false;
            }

            if(QGameData.instance.getMaxCheckPoint()<3){
            ...
            QSceneMgr.instance.initUIEffect();
        ...
        public flyResAni(param){
            if (QUIMgr.instance.uiIsActive(QUIMgr.UI_LuckyGuy))
                return;
    ...
    //  -------------------------------      删除车辆引导    Begin     ------------------------------
        ...
        public deleteCarGuideStart(){
            ...
            if( QGameData.instance.deleteCarGuide == "Close" ){  // 引导次数达到上限
                return;
            }
            ...
            Laya.timer.once( 1000 , self , function (){  // 若有可以合成车辆 不执行引导
                ...
                if( isCanOpen == 1 ){  // 不满足开启引导
                    ...
                    QGameData.instance.setDeCarGuideState("NoGuide");
                    return;
                } else {  // 可以开启引导
                    // 开启垃圾桶 引导效果
                    self.trashChangeState("open");
                    // 设置目前处于 引导状态
                    QGameData.instance.setDeCarGuideState("InGuide");
                }
            })
        }
        ...
        judgeIsCanCompound(){
            ...
            var curCarData = QMergeData.instance.getCarSlotData(); // 当前场上车辆等级
            if( ! curCarData ){
                return 1; // 不满足开启引导
            }
            if(QMergeData.instance.JudgeSolt() == -1){  // 判断场上车辆已满
                for( var i = 0 ; i < 12 ; i++ ){
        ...
        // 加载主界面下 判断是否引导状态
        judgeDelGuideByMain(){
            if ( ! this.scene || QGameData.instance.deleteCarGuide == "Close" ){
                return;
            }
            ...
            // 是引导状态 , 开启背景光效
            if( QGameData.instance.delCarGuideState == "InGuide" ){
        ...
        freshTrashState(state){
            ...
            if( state == "IN" ){  // 移入
                ...
                this.trashChangeState("close");
                QGameData.instance.setDeCarGuideState("NoGuide"); // 本次引导结束
        ...
        clickTrashInGuide(){
            ...
            if ( QMergeData.instance.JudgeSolt() == -1  && QGameData.instance.delCarGuideState == "InGuide" && QGameData.instance.deleteCarGuide != "Close") {
                // 正在初始化引导
                if( this.isInJudge == true ){
                    return;
                }
                // 是否小手引导 /  与其他小手引导冲突
                if( this.handInGuide || QGameData.instance.isHandGuideFix ){
                    return;
                }
        ...
        private deleteChangeState(){
            var curTime = QGameData.instance.deleteCarGuide;
            if( curTime == "First" ){
                QGameData.instance.setDeleteCarGuideTime("Second");
            } else if( curTime == "Second" ){
                QGameData.instance.setDeleteCarGuideTime("Close");
            }
        }
        ...
        //  -------------------------------      空投功能    Begin     ------------------------------
          ...
          judgeCanDrop() : boolean {
            let curMaxCheckPoint = QGameData.instance.getCheckPoint();  // 获取目前解锁的最高关卡
            let maxCarLevel = QMergeData.instance.getCarMaxLevel();     // 获取 最高等级车辆信息
        ...
        freshAirDropState(){
            ...
            if(QMergeData.instance.CarMaxLevel <= QMergeData.instance.AirDropLevel) {
                // 降临到停车位
                let curMaxCheckPoint = QGameData.instance.getCheckPoint();  // 获取目前解锁的最高关卡
                if( curMaxCheckPoint >= 3 ){  // 如果为第三关( 两关的引导结束,解锁第三关 ) 立即出现空投
                    if(QGameData.instance.newPlayerGudieStep(null) >= QGameConst.NumForGuide.weaponUpdate && QGameData.instance.airDrop_promptly_show && QGameData.instance.airDrop_promptly_show == "false" ){
                        QDebug.D("第一次显示空投箱-----------------");
                        // 出现空投onCreateAirDrop
                        QMergeData.instance.createAirDrop();
                        QGameData.instance.setAirDropInstance("true"); // 使用过空投,设置状态
                        return
                    }
                    // 判断 空投是否显示
                    if(QMergeData.instance.AirDropIsOpen == 2) {
                        // 空投状态  0 显示未开启 1 显示已开启  2 未显示空投 3 停车位已满
                        QMergeData.instance.initAirDropTime();
                    }
                    if(QMergeData.instance.AirDropIsOpen == 0 && QMergeData.instance.AirDropCount > 0) {
                        if (QMergeData.instance.judgeCarSlotDataAirdrop() == -1 ){
                            QMergeData.instance.createAirDrop();
                        }
                    }
                ...
                // 判断 空投是否显示
                if(QMergeData.instance.AirDropIsOpen == 0 || QMergeData.instance.AirDropIsOpen == 1) {
                    if (QMergeData.instance.judgeCarSlotDataAirdrop() == -1){
                        // 首先判断停车位是否空投箱
                        // 显示空投
                        if (QMergeData.instance.AirDropIsOpen == 1){
        ...
        public onShowAirDrop() {
            ...
            this.scene.dropNumLabel.text = QMergeData.instance.AirDropCount + "";  // 显示空投剩余的数量
        }
        ...
        //         this.scene.shakeDropOnce.play(0,true);
        //     })
        //     var stringNum = QSavedDateItem.instance.getItemFromLocalStorage("AIR_DROP_CAR_NUM", "12"); // (string)
        //     var haveCarNum = 0;
         ...
         */
        openAirDrop() : void{
            if( this.judgeCanDrop() &&  QMergeData.instance.CarMaxLevel >= QMergeData.instance.AirDropLevel){
                if( ! this.scene ){
                    return;
                }
                QDebug.D("显示空投 ----------------------------------------1");
                ...
                var stopAnim = function():void{
                    QDebug.D("显示空投 ----------------------------------------3");
                    QSoundMgr.instance.playSfx(QSoundMgr.instance.soundInfo_wav.airdrop);
                    ...
                    this.scene.dropNumLabel.text = QMergeData.instance.AirDropCount + "";
                }
        ...
        public shareCallBack(param){
            ...
            QMergeData.instance.setAirDropOpenState(1,{x:this.scene.positionBox.x - 50, y :this.scene.positionBox.y});
            if(QMergeData.instance.JudgeSolt() == -1) {
                QUIMgr.instance.createUI(QUIMgr.UI_Tip, { text: "车位已满，请先合成或回收车辆" });
        ...
        checkPopSignUi(): boolean {
            let new_date = new Date();
            let date_str = new_date.toLocaleDateString();
            let sign_date_str = QSavedDateItem.instance.getItemFromLocalStorage("GAME_SIGIN_DATE", "0");
            let sigin_days = parseInt(QSavedDateItem.instance.getItemFromLocalStorage("GAME_SIGIN_DAYS", "0"));
            var flag = QSavedDateItem.instance.getItemFromLocalStorage("GAME_SIGIN_DAYS_GREATER_7", "0");
            ...
            var state = QSavedDateItem.instance.getItemFromLocalStorage("GAME_SIGIN_DATE_STATE", "0");
            if(state == "0"){
                QSavedDateItem.instance.setItemToLocalStorage("GAME_SIGIN_DATE_STATE", "1");
            }else {
        ...
        checkGuideStep(){
            if(QGameData.instance.getMaxCheckPoint()>3) return false;
            ...
            if(stepIdx >= 0){
                ...
                switch(stepIdx + 1){
                    case QGameConst.NumForGuide.enterGame:
                            stepData.nArr.push([this.scene.btn_start_game]);
                            stepData.key = [1];
                            stepData.perform = [
                                QGameConst.NumForGuide.enterGame
                            ];
                    break;

                    case QGameConst.NumForGuide.getResult:
                            QGameData.instance.newPlayerGudieStep(QGameConst.NumForGuide.getResult);
                            stepIdx = QGameConst.NumForGuide.getResult;
                    case QGameConst.NumForGuide.buyCar:
                    case QGameConst.NumForGuide.synthetic:
                            ...
                            stepData.key = [1,2];
                            stepData.perform = [
                                QGameConst.NumForGuide.buyCar,
                                QGameConst.NumForGuide.synthetic,
                            ];
                    break;
                    case QGameConst.NumForGuide.enterGameAgain:
                            stepData.nArr.push([this.scene.btn_start_game]);
                            stepData.key = [1];
                            stepData.perform = [QGameConst.NumForGuide.enterGameAgain];
                    break;
                    case QGameConst.NumForGuide.weaponUpdate:
                        stepData.nArr.push([this.scene.btn_levelUp]);
                        stepData.key = [1];
                        stepData.perform = [QGameConst.NumForGuide.weaponUpdate];
                    break;
                    case QGameConst.NumForGuide.allStep:
                        QGameData.instance.newPlayerGudieStep(QGameConst.NumForGuide.allStep);
                        return false;
                }
                let guideMgr = QUIMgr.instance.createUI(QUIMgr.UI_GameGuideView);
                guideMgr.createForcedGuide(stepData,stepIdx + 1);
                return true;
            }
            // else{
            //     let lvUp = QGameData.instance.getLvUpGuideTouch(null);
        ...
        public checkBuyGuide () {
            ...
            {
                let carData = QMergeData.instance.getCarSlotData();
                let inMap   = 0;
            ...
            if(isShow){
                ...
                this.softGuideType = QGameConst.softGuidePriority.buyCar;
            }
            else
            {
                QMergeData.instance.resetBuyGuideTime();
            }
        }
        //合成车软引导
        public syntheticGuide () {
            ...
            let info = QMergeData.instance.getSameCarInMap();
            if(info.canIdx.length)
            {
                let guideMgr = QUIMgr.instance.createUI(QUIMgr.UI_GameGuideView);
                this.softGuideType = QGameConst.softGuidePriority.synthetic;
                let param = {
        ...
        checkAutoPopUi(){
            if (QMergeData.instance.IsFirst == true) {
                // 第一次进入游戏大厅
                // 判断离线收益
                QMergeData.instance.IsFirst = false;
                Laya.timer.frameOnce(1, this, () => {
                    let popSignUi = this.checkPopSignUi();
                    let popOffLineUi = QMergeData.instance.addOffLineGold(popSignUi);
                });
            } else {
                QMergeData.instance.onbackHall();
            }
        }
        ...
        {
            QGameData.instance.initTitlePos(this.scene.title_diamond,this.scene.title_gold);
            QGameData.instance.initResourcesPool();
            ...
            // 创建抽屉UI
            QUIMgr.instance.createUI(QUIMgr.UI_DrawerDialog);
            // 显示当前所用赛车
        ...
        showPointInfo()
        {
            let check_point = QGameData.instance.getCheckPoint();
            if (check_point <= 1)
            {
                check_point = 1;
                this.scene.pre_point_bg.visible = false;
            } else if (check_point >= QGameData.instance.max_check_point_count) {
                check_point = QGameData.instance.max_check_point_count;
        ...
        checkLuckyRotaryCount(){
            //let resetTime = QMergeData.instance.getRotaryTabelResetTime();
            let maxCount = QMergeData.instance.getRotaryTableFreeCount();
            let curCount = parseInt(QSavedDateItem.instance.getItemFromLocalStorage("GAME_ROTARY_TABEL_CURR_COUNT", "5"));
        ...
        checkWeaponLevelUpTag(){
            ...
            this.scene.img_levelUp_notice.visible = false;
            let coin = QGameData.instance.getWeaponsCoin();
            let diamond = QMergeData.instance.getGameDiamond();

            let mainLevel = QGameData.instance.getMainWeaponLevel();
            let mainCost = QCfgMgr.instance.getBaseMainWeapons()[mainLevel+''].cost;

            let mainWeaponLevel = QGameData.instance.getMainWeaponLevel();
            if (coin >= mainCost && !this.WeaponFullLevel/* && !(mainWeaponLevel >= QGameData.instance.mainWeaponMaxLevel)*/) {
                this.scene.img_levelUp_notice.visible = true;
                return;
            }

            let deputyLevel = QGameData.instance.getDeputyWeaponLocalLevel();
            if (deputyLevel) {
                let deputyCost = QCfgMgr.instance.getDeputyWeapons(deputyLevel).sCoin;
                let needMoney = QCfgMgr.instance.getDeputyWeapons(deputyLevel).sChoice == 1 ? coin : diamond;
                let deputyWeaponMaxLevel = QGameData.instance.getDeputyWeaponMaxLevel();
                let deputyWeaponLevel = QGameData.instance.getDeputyWeaponLocalLevel();
            ...
            let curSelectUav = QGameData.instance.getCurUseUAV();
            if (curSelectUav != -1) {
                let uavLocalData = QGameData.instance.getUAVData();
                if (!uavLocalData) {
                    return;
                }

                let uavConfig = QCfgMgr.instance.getUAVWeaponsCfg();
                let pay = uavConfig[curSelectUav.toString()][uavLocalData[curSelectUav.toString()]].Coin;
                if (coin >= pay && !this.WeaponFullLevel){
                     this.scene.img_levelUp_notice.visible = true;
                }
            }else if(curSelectUav == -1 && QGameData.instance.getCheckPoint() >= QGameData.instance.getUAVWeaponOpenPoint()){  //解锁了无人机，但是没有选择
                this.scene.img_levelUp_notice.visible = true;
            }
        }
        ...
        checkShopFreeCarTag()
        {
            ...
            let curMaxLevel = QMergeData.instance.getCarMaxLevel();
            let carConfig = QCfgMgr.instance.getRoadsideCarList();
            for (let key in carConfig)
            {
                if (carConfig[key].level == curMaxLevel)
                {
                    ...
                    let lastVideoCarTime = QSavedDateItem.instance.getItemFromLocalStorage("GAME_LAST_VIDEO_BUY_CAR", "0");
                    if (bonusCar_level && bonusCar_level != -1 && (time - parseInt(lastVideoCarTime)) > QMergeData.instance.SHOP_VIDEO_BUY_CAR)
                    {
        ...
        */
        ...
        {
            let count = QUtil.formatNumberStr(QGameData.instance.getWeaponsCoin().toString());
        ...
        public onUpLevel(): void
        {
            ...
            // 显示升级界面
            //QUIMgr.instance.createUI(QUIMgr.UI_LevelUp);

            // QSavedDateItem.instance.setItemToLocalStorage("GAME_LAST_VIDEO_BUY_CAR", "0");
        }
        /**
         * 刷新金币
         */
        onUpdateGameGold(): void
        {
            ...
            var rate_str = "+" + QUtil.formatNumberStr(QMergeData.instance.getGoldAllSpeed() + "") + "/s";
        ...
        {
            var level = QMergeData.instance.getUserLevel();
            var exp = QMergeData.instance.getUserExperience();
            // 增加经验动画
            if (exp - this.last_exp)
            {

            }
            var exp_max = QCfgMgr.instance.getLevelInfo(level).level_up_exp;
        ...
        {
            let game_temp_earning_time = QMergeData.instance.getGameTempEarningTime();
            if (game_temp_earning_time > 0)
            {
                ...
                QMergeData.instance.setGameTempEarningTime(-1)
            } else
            {
                if (this.earning)
                {
            ...
            var str = "+" + QUtil.formatNumberStr(QMergeData.instance.getGoldAllSpeed() + "") + "/s";
            this.scene.lab_game_rate.text = str;
            this.resetGoldLabPos();

            this.scene.lab_earnings.text = "收益:" + Math.floor(QMergeData.instance.getGameEarnings() * 100) + "%";
            this.onUpdateBuyCar();
        }
        ...
        private onUpdateCarSlot()
        {
            ...
            this.pos_list = QMergeData.instance.getGameCarSlotPos(count);
            if (!QUtil.isNullOrEmpty(this.pos_list))
            {
                ...
                for (var i = 0; i < 12; i++)
                {
                    if (i < count)
                    {
                        ...
                        QEventMgr.instance.sendEvent(QEventType.MAIN_VIEW_TOUCH_UP_CAR_INDEX, { "index": i });//更新车的位置
                    } else
                    {
        ...
        {
            let max_check_point = QGameData.instance.getMaxCheckPoint();
            if (max_check_point < QGameData.instance.getChoosePointOpenPoint()) {
                QUIMgr.instance.createUI(QUIMgr.UI_Tip,{text : QGameData.instance.getChoosePointOpenPoint()+"关之后可选关"});
                return;
            }
            tywx.BiLog.clickStat(tywx.clickStatEventType.clickTheSelectLevelButton,[]);
            QUIMgr.instance.createUI(QUIMgr.UI_CheckPointChoose);
            ...
            switch (param)
            {
                case "pre":
                    ...
                    QGameData.instance.setCheckPoint(check_point - 1);
                    if (check_point <= 2)
                    {
        ...
        public onBtnClick(params)
        {
            ...
            {
                if(this.softGuideType == QGameConst.softGuidePriority.buyCar)
                {
            ...
            {
                if (QMergeData.instance.isMergeState == true) {
                    return
                }
                //QSoundMgr.instance.stopBgm();
                QEventMgr.instance.sendEvent(QEventType.GAME_GUIDE_CTRL);
                QUIMgr.instance.createUI(QUIMgr.UI_QGameLoadingView,"game");
            ...
            else if (params == "btn_shop")
            {
                ...
                QUIMgr.instance.createUI(QUIMgr.UI_ShopDialog,this.shopFreeCarindex);
                if(QMergeData.instance.getCarMaxLevel()>5)
                {
                    this.resetShopSoftGuide();
                    QMergeData.instance.setShopSoftGuide(1);
                }
            }
            ...
            {
                QUIMgr.instance.createUI(QUIMgr.UI_LuckyGuy);
                // QUIMgr.instance.createUI(QUIMgr.UI_BeOffline);
            }
            else if (params == "btn_levelUp")
            {
                QEventMgr.instance.sendEvent(QEventType.GAME_GUIDE_CTRL);
                QUIMgr.instance.createUI(QUIMgr.UI_WeaponLevelUpView);
                this.scene.lvUp_hand.visible = false;
                QGameData.instance.getLvUpGuideTouch(1);
                ...
                if(QMergeData.instance.getPopJcdlCfg().length > 0){
                    QJcdlTypeView.instance.create({type : 4 });  //创建抽屉交叉导流
                }else{
                    QUIMgr.instance.createUI(QUIMgr.UI_Tip, {text: "无可试玩的游戏，请明天再来～"});
                }
                // QSavedDateItem.instance.setItemToLocalStorage("MORE_GAME_NOTICE", "false");
                // this.updateMoreGameNotice();
            }else if(params == "btn_online_gift"){
                if(!this.checkGift){
                    QUIMgr.instance.createUI(QUIMgr.UI_Tip,{text : "倒计时结束点击宝箱有惊喜~"});
                }else{
                    QUIMgr.instance.createUI(QUIMgr.UI_OnlineGift, 1);
                }
        ...
        public updateMoreGameNotice(){
            var num = QMergeData.instance.getPopJcdlCfg().length;
            if(num > 0){
        ...
        {
            var game_gold = QMergeData.instance.getGameGold();
            if (game_gold > 0 && QUtil.StrJudge(game_gold + "", this.buy_car_info["price"]) != 0)
            {
        ...
        {
            　//QDebug.D("刷新购买车UI--------------onUpdateBuyCar");

            this.buy_car_info = QMergeData.instance.getCheapestCar();
            this.scene.img_buy_car.skin = this.buy_car_info["path"];
            this.scene.label_buy_car_price.text = QUtil.formatNumberStr(this.buy_car_info["price"]);
            var game_gold = QMergeData.instance.getGameGold();
            if (game_gold > 0 && QUtil.StrJudge(game_gold + "", this.buy_car_info["price"]) != 0)
            {
                this.scene.btn_car_list.gray = false;
        ...
        public onBuyCar()
        {
            //1 判断卡槽是否还存在
            //2 创建车辆
            var _index = QMergeData.instance.JudgeSolt();
            if (_index == -1)
            {
                // 卡槽已满
                QDebug.D("车位已满--------------");
                ...
                QSoundMgr.instance.playSfx(QSoundMgr.instance.soundInfo_wav.touch);
                if(QGameData.instance.delCarGuideState == "InGuide" || QGameData.instance.deleteCarGuide != "Close"){
                    QEventMgr.instance.sendEvent(QEventType.DELETE_CAR_TRASH_STATE , "FULL");
                }
            } else
            {
                var game_gold = QMergeData.instance.getGameGold();
                ...
                {
                    // 减去金币
                    QMergeData.instance.SubtractGameGold(this.buy_car_info["price"]);
                    var data: any = {};
                    data.level = this.buy_car_info.level;
                    data.state = 2; // 1 直接显示  0 显示箱子 2 缩小动作
                    let needLeveUp = this.showCarFreeLeveUp(data.level);
                    if (QMergeData.instance.showFreeLvUpCar && needLeveUp != -1)
                    {
                        data.needLeveUp = needLeveUp;
                        QUIMgr.instance.createUI(QUIMgr.UI_FreeLeveUp, { "index": _index, "data": data });
                    } else
                    {
                        // 修改车位数据
                        QMergeData.instance.changeCarSlotData(_index, data);
                        // 增加车辆的购买次数
                        QMergeData.instance.addBuyCarCount(this.buy_car_info.level, QGameConst.QMoneyType.Coin);
                        //更新车的位置
                        QEventMgr.instance.sendEvent(QEventType.MAIN_VIEW_TOUCH_UP_CAR_INDEX, { "index": _index });
                        // 刷新最优车辆
                        this.onUpdateBuyCar();
                    }
                    QSoundMgr.instance.playSfx(QSoundMgr.instance.soundInfo_wav.buy_car);
                    tywx.BiLog.clickStat(tywx.clickStatEventType.onClickFastBuyCar,[]);
                } else
                {
                    QSoundMgr.instance.playSfx(QSoundMgr.instance.soundInfo_wav.touch);
                    if(QGameData.instance.getLvUpGuideTouch(null) == 1 && QMergeData.instance.getShopSoftGuide() == 0 && this.softGuideType == 0)
                    {
                        // let isAuditVersion = QWxSDK.instance.isAuditVersion();
                        // if(QMergeData.instance.getCarMaxLevel()>3 && QMergeData.instance.getCarMaxLevel()<10 && !isAuditVersion)
                        // {
                        //     this.scene.shop_hand.visible = true;
                        //     QGameData.instance.isHandGuideFix = true;
                        //     this.softGuideType = QGameConst.softGuidePriority.shop;
                        // }
                    }
                    QUIMgr.instance.createUI(QUIMgr.UI_FreeGoldGet,QGameConst.QCurrencyType.gold);
                }
            }
        }
        ...
        private showCarFreeLeveUp(buyVarLv)
        {
            let next_level = -1;
            let time = new Date().getTime();
            let lastFreeLvUp = QSavedDateItem.instance.getItemFromLocalStorage("GAME_LAST_CAR_FREE_LEVEL_UP", "0");
            if (time - parseInt(lastFreeLvUp) > QMergeData.instance.CAR_FREE_LEVEL_UP)
            {
                ...
                if (carConfig)
                {
                    ...
                    {
                        let freeCarsConf = QCfgMgr.instance.getFreeCarsLevelUpConf();
        ...
        {
            QDebug.D("onMouseDown  ");
            var pos: any = this.scene.localToGlobal(new Laya.Point(param.stageX, param.stageY));
            pos.stageX = pos.x;
            pos.stageY = pos.y;
            QEventMgr.instance.sendEvent(QEventType.MAIN_VIEW_TOUCH_DOWN, pos);

            QEventMgr.instance.sendEvent(QEventType.MAIN_VIEW_CLOSE_DRAWER);
        }
        // 选中的车的原始位置
        private oldpos: any = {};
        // 选中的车的原始等级
        ...
        {
            if(QGameData.instance.delCarGuideState == "InGuide" || QGameData.instance.deleteCarGuide != "Close"){
                QEventMgr.instance.sendEvent(QEventType.DELETE_CAR_TRASH_STATE , "HAND"); // 判定是否处于删除车辆手指正在引导
            }
            // 获取 车位数据
            var CarSlotData = QMergeData.instance.getCarSlotData();
            ...
            var car_data = QCfgMgr.instance.getCarInfoById(car_slot_data.level);
            if (car_data == null) {
                return;
            }
            ...
            this.touch = true;
            QEventMgr.instance.sendEvent(QEventType.MAIN_VIEW_SHOW_PROMPT, car_slot_data.level);
            // 车位 位置
            var count = QMergeData.instance.getGameCarSlot();
        ...
        private onMouseOut(param): void
        {
            ...
            {
                this.touch = false;
                QEventMgr.instance.sendEvent(QEventType.MAIN_VIEW_TOUCH_OUT);
        ...
        private onMouseUp(param): void
        {
            if (this.touch == true)
            {
                ...
                if (pos && !QUtil.isNullOrEmpty(pos.stageX) && !QUtil.isNullOrEmpty(pos.stageY) ) {
                    QEventMgr.instance.sendEvent(QEventType.MAIN_VIEW_TOUCH_UP, pos);
                }
            }
        }
        ...
        private inCleanNode(): void{
            if(this.scene.sprite_move.x >= 30 && this.scene.sprite_move.x <= 140 && this.scene.sprite_move.y >= 1174 && this.scene.sprite_move.y <= 1284){
                ...
                QEventMgr.instance.sendEvent(QEventType.IN_CLEAN, true);
            }else{
                // 只有在移动 进入过一次之后才执行这里
                if( this.haveMoveInTrash == true ){
                    QEventMgr.instance.sendEvent(QEventType.OUT_CLEAN, false);
        ...
        {
            QUIMgr.instance.createUI(QUIMgr.UI_GainCar);
        }
        ...
        {
            return;
            if(QWxSDK.instance.isAuditVersion())
            {
                this.runSoftGuide = false;
                return;
            }
            //软引导的一些东西们
            let lvUpGuide = QGameData.instance.getLvUpGuideTouch(null);
            let stepIdx   = QGameData.instance.newPlayerGudieStep(null);
            if(QMergeData.instance.getCarMaxLevel() < 7){
                if(lvUpGuide == 1 && stepIdx < 0)
                {
                    this.runSoftGuide = true;
                    let canSoftSynthetic = QMergeData.instance.getSyntheticSoft();
                    if(canSoftSynthetic == 0)
                    {
                        Laya.timer.loop(1000,this,this.syntheticTimeCheck);
                    }
                    let times = QMergeData.instance.getBuyGuideTime();
                    if(times >= 30)
                    {
                        this.resetBuySoftGuide();
                        this.checkBuyGuide();
                ...
                QMergeData.instance.setSyntheticSoft(1);
            }
        }
        ...
        {
            let canSoftSynthetic = QMergeData.instance.getSyntheticSoft();
            if(canSoftSynthetic == 0 && this.softGuideType == QGameConst.softGuidePriority.synthetic)
            {
                //**关闭合成车的引导了*/
                Laya.timer.clear(this,this.syntheticTimeCheck);
                this.softGuideType  = 0;
        ...
        {
            if(this.softGuideType == QGameConst.softGuidePriority.shop)
            {
        ...
        {
            let luckyTimes = parseInt(QSavedDateItem.instance.getItemFromLocalStorage("GAME_ROTARY_TABEL_CURR_COUNT", "5"));
            this.scene.imgRedHint.visible = (luckyTimes!=0 || QMergeData.instance.getIsFirstClickLuckyState()==0);
        ...
        public getWeapeonNoticeCtr(){
            let judge = QSavedDateItem.instance.getItemFromLocalStorage("ALL_FULL_LEVEL", "false");
            if(judge == "false"){
            ...
            let curCarMaxLevel = QMergeData.instance.getCarMaxLevel();  //车辆最大等级
            let curCheckPoint = QGameData.instance.getCheckPoint();  //解锁的最大关卡
            if(this.unlockDeputy == "false" && curCarMaxLevel >= QGameData.instance.getDeputyWeaponOpenPoint()){
                this.unlockDeputy = "true";
                this.WeaponFullLevel = false; //解锁副武器的时候，副武器肯定不是满级
                QSavedDateItem.instance.setItemToLocalStorage("UNLOCK_DEPUTY", "true");
                QSavedDateItem.instance.setItemToLocalStorage("ALL_FULL_LEVEL", "false");
                // console.log("解锁副武器");
                return ;
            }
            if(this.unlockUav1 == "false" && curCheckPoint >= curSelectUavData1[1].unlocking){
                ...
                QSavedDateItem.instance.setItemToLocalStorage("UNLOCK_UAV_1", "true");
                QSavedDateItem.instance.setItemToLocalStorage("ALL_FULL_LEVEL", "false");
                // console.log("解锁无人机1");
                return ;
            }
            if(this.unlockUav2 == "false" && curCheckPoint >= curSelectUavData2[1].unlocking){
                ...
                QSavedDateItem.instance.setItemToLocalStorage("UNLOCK_UAV_2", "true");
                QSavedDateItem.instance.setItemToLocalStorage("ALL_FULL_LEVEL", "false");
                // console.log("解锁无人机2");
                return ;
            }
            if(this.unlockUav3 == "false" && curCheckPoint >= curSelectUavData3[1].unlocking){
                ...
                QSavedDateItem.instance.setItemToLocalStorage("UNLOCK_UAV_3", "true");
                QSavedDateItem.instance.setItemToLocalStorage("ALL_FULL_LEVEL", "false");
                // console.log("解锁无人机3");
                return ;
            }
            if(this.unlockUav4 == "false" && curCheckPoint >= curSelectUavData4[1].unlocking){
                ...
                QSavedDateItem.instance.setItemToLocalStorage("UNLOCK_UAV_4", "true");
                QSavedDateItem.instance.setItemToLocalStorage("ALL_FULL_LEVEL", "false");
                // console.log("解锁无人机4");
                return ;
            }
            if(this.unlockUav5 == "false" && curCheckPoint >= curSelectUavData5[1].unlocking){
                ...
                QSavedDateItem.instance.setItemToLocalStorage("UNLOCK_UAV_5", "true");
                QSavedDateItem.instance.setItemToLocalStorage("ALL_FULL_LEVEL", "false");
                // console.log("解锁无人机5");
                return ;
            }
        ...
        public getUnlockWeapon(){
            this.unlockDeputy = QSavedDateItem.instance.getItemFromLocalStorage("UNLOCK_DEPUTY", "false");
            this.unlockUav1 = QSavedDateItem.instance.getItemFromLocalStorage("UNLOCK_UAV_1", "false");
            this.unlockUav2 = QSavedDateItem.instance.getItemFromLocalStorage("UNLOCK_UAV_2", "false");
            this.unlockUav3 = QSavedDateItem.instance.getItemFromLocalStorage("UNLOCK_UAV_3", "false");
            this.unlockUav4 = QSavedDateItem.instance.getItemFromLocalStorage("UNLOCK_UAV_4", "false");
            this.unlockUav5 = QSavedDateItem.instance.getItemFromLocalStorage("UNLOCK_UAV_5", "false");
            // console.log("解锁的无人机");
        ...
        public onlineGiftTime(){
            ...
            let giftTimeArr = QCfgMgr.instance.getOnlineGiftTime();  //获取在线宝箱的出现间隔时间配置
            ...
            if(QResMgr.instance.RES_GAME){  //已经加载过游戏
                let time = new Date().valueOf();
                let timeStart = Number(QSavedDateItem.instance.getItemFromLocalStorage("GIFT_TIME_START", ""));
        ...
        */
        ...
        public getGiftShowTime(){
            this.getGiftTimes = QSavedDateItem.instance.getItemFromLocalStorage("GET_GIFT_TIMES", "0");
        ...
        public setGiftShowTime(giftTimes){
            QSavedDateItem.instance.setItemToLocalStorage("GET_GIFT_TIMES", giftTimes);
        }
        ...
        public getGiftSuccess(){
            ...
            let time = new Date().valueOf();
            QSavedDateItem.instance.setItemToLocalStorage("GIFT_TIME_START", time.toString());
        ...
        public isSameday(){
            ...
            if(day != QSavedDateItem.instance.getItemFromLocalStorage("DAY", "0")){
                //不是同一天
         ...
         */
        dateStorage(day){
            QSavedDateItem.instance.setItemToLocalStorage("DAY", day);
        }
        //强制引导蒙层按钮层级移动处理
        public startForceGuide(nodeArr)
        {
            ...
            QUIMgr.instance.setDialogActive(QUIMgr.UI_DrawerDialog,false);
        ...
        {
            if(QGameData.instance.newPlayerGudieStep(null)==QGameConst.NumForGuide.weaponUpdate){
                QUIMgr.instance.setDialogActive(QUIMgr.UI_DrawerDialog,true);
            }
...
export default game.view.QMainView;