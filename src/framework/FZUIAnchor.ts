...
{
	export class FZUIAnchor extends Laya.Script
	{
		...
		public reposition(): void
		{
			...
			switch (this.anchroType)
			{
				case 'Center':
					...
					this.uiComponent.x = (isFitByWidth ? FZConst.DesignWidth / 2 : (Laya.Browser.width / 2 * radio)) + this.pixelOffsetX;
					this.uiComponent.y = (isFitByWidth ? (Laya.Browser.height / 2 * radio) : FZConst.DesignHeight / 2) + this.pixelOffsetY;
					break;
				case 'Left':
				...
				case 'BottomLeft':
					...
					this.uiComponent.y = (isFitByWidth ? Laya.Browser.height * radio : FZConst.DesignHeight) + this.pixelOffsetY;
					break;
				case 'Right':
					this.uiComponent.anchorX = 1;
					this.uiComponent.anchorY = 0.5;
					this.uiComponent.x = (isFitByWidth ? FZConst.DesignWidth : (Laya.Browser.width * radio)) + this.pixelOffsetX;
					this.uiComponent.y = (isFitByWidth ? (Laya.Browser.height / 2 * radio) : FZConst.DesignHeight / 2) + this.pixelOffsetY;
					break;
				case 'TopRight':
					this.uiComponent.anchorX = 1;
		...
		{
			FZDebug.log("anchorType: " + this.anchroType + ", offsetX: " + this.pixelOffsetX + ", offsetY: " + this.pixelOffsetY);
		}
	}
}

export default fastline.framework.FZUIAnchor;