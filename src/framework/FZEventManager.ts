...
namespace fastline.framework
{
	...
	export class FZEventManager
	{
		private constructor() { }

		private static _instance: FZEventManager;
		public static get instance(): FZEventManager
		{
			if (FZEventManager._instance == null)
			{
				FZEventManager._instance = new FZEventManager();
			}
			return FZEventManager._instance;
		}
		
		public static destroy(): void
		{
			FZEventManager._instance = null;
		}
...
export default fastline.framework.FZEventManager;